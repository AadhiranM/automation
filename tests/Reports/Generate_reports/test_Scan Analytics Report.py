...
#
#             self.logger.info(f"Scan analytics report successful | {toast_text}")
#
#         else:
#
#             take_screenshot(
...
#                 folder_name="Screenshots\\reports\\Generate_reports\\Scan_Analytics_Report"
#             )
#
#             self.logger.error(f"Scan analytics report failed | Toast: {toast_text}")
#
#             assert False, f"Scan analytics report generation failed | Toast: {toast_text}"
#
#         time.sleep(1)
...
class Test_R_Scan_analytics_report(BaseTest):
    ...
    def test_Scan_analytics_report(self, driver, data):
        ...
        self.logger.info(
            f"===== Scan Analytics Report Flow Started | Report: {report_name} ====="
        )
        ...
        report.Click_scan_analytics_reports()
        self.logger.info("Selected Scan Analytics Report")
        ...
        if toast_text and "Report generation has been initiated successfully!" in toast_text:
            ...
            self.logger.info(
                f"Scan analytics report generated successfully | {toast_text}"
            )
            ...
            self.logger.error(
                f"Scan analytics report failed | Toast: {toast_text}"
            )
