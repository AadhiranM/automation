...
class Test_QRM_products(BaseTest):
    ...
    def test_QR_management_products_flow(self, driver, data):
        ...
        #     )
        #     self.logger.error(f"Create product failed for '{data['product_name']}'")
        #     assert False, "Product creation failed"
        #     return
        ...
        if toast_text and "Product created successfully!" in toast_text:
            print("✅ Product created successfully")
            self.logger.info(f"Product created successfully '{data['product_name']}' {toast_text}")
            ...
            self.logger.error(f"Create product failed for '{data['product_name']}' {toast_text}")
            assert False, f"Product creation failed. Toast: {toast_text}"