...
from pages.superadmin.QRcodemonitoring.sa_qr_not_recognized_feedback_page import (
    SAQrNotRecognizedFeedbackPage
)


@pytest.mark.superadmin
@pytest.mark.usefixtures("login_superadmin")
class TestQrNotRecognizedFeedback:

    # ==================================================
    # SEARCH
    # ==================================================
    def test_search(self, setup):
        page = SAQrNotRecognizedFeedbackPage(setup)
